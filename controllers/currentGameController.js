import { notInAGame, InAGame, displayTeamStats, gameInformation, shouldForfeit, updateAllStatsInDOM, updateTeamStatsInDOM } from '../views/currentGameDisplay.js';
import { getLiveData } from '../models/currentGameModel';
